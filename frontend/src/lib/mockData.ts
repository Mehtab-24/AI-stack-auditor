export type Category =
  "coding" | "writing" | "meetings" | "design" | "support" | "analytics" | "search";
...
export const agentTraceSteps: {
  ...
  },
  {
    ...
    result:
      "Determined ROI metrics - Copy.ai and Copilot confirmed high value, Cursor Pro low value",
  },
  {
    agent: "Alternative Recommendation Agent",
    label: "Alternatives",
